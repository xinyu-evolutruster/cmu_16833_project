...
void readParameters(ros::NodeHandle &n)
{
    ...
    std::ofstream foutC("/home/cindy/16833/project/catkin_PLVINS/src/PL-VINS/outout/tum_plvins.txt", std::ios::out);
    foutC.close();
    std::ofstream foutC1("/home/cindy/16833/project/catkin_PLVINS/src/PL-VINS/outout/evo_plvins.txt", std::ios::out);
    foutC1.close();
