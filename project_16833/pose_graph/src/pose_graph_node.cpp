...
int main(int argc, char **argv)
{
    ...
    if (LOOP_CLOSURE)
    {
        ...
        // fout.close();
        fsSettings.release();
        std::ofstream foutC("/home/cindy/16833/project/catkin_PLVINS/src/PL-VINS/Trajactory/tum_fast_plvins_loop.txt", std::ios::out);
        foutC.close();
        std::ofstream foutC1("/home/cindy/16833/project/catkin_PLVINS/src/PL-VINS/Trajactory/evo_fast_plvins_loop.txt", std::ios::out);
        foutC1.close();
