...
void PoseGraph::addKeyFrame(KeyFrame *cur_kf, bool flag_detect_loop)
{
    ...
    if (SAVE_LOOP_PATH)
    {
        ...
        ofstream foutC("/home/cindy/16833/project/catkin_PLVINS/src/PL-VINS/Trajactory/tum_fast_plvins_loop.txt", ios::app);
        ...
        ofstream foutC1("/home/cindy/16833/project/catkin_PLVINS/src/PL-VINS/Trajactory/evo_fast_plvins_loop.txt", ios::app);
...
void PoseGraph::updatePath()
{
    ...
    for (it = keyframelist.begin(); it != keyframelist.end(); it++)
    {
        ...
        if (SAVE_LOOP_PATH)
        {
            ...
            //       << endl;
            // loop_path_file.close();
            ofstream foutC("/home/cindy/16833/project.catkin_PLVINS/src/PL-VINS/output/tum_fast_plvio_loop.txt", ios::app);
            foutC.setf(ios::fixed, ios::floatfield);
            foutC.precision(0);
            ...
            ofstream foutC1("/home/cindy/16833/project.catkin_PLVINS/src/PL-VINS/output/evo_fast_plvio_loop.txt", ios::app);
            foutC1.setf(ios::fixed, ios::floatfield);
            foutC1.precision(9);
