...
int main(int argc, char **argv)
{
  ...
  std::string filename = "/home/cindy/16833/project/catkin_PLVINS/src/PL-VINS/config/euroc/euroc_config_fix_extrinsic.yaml";

  ROS_INFO("ImageNodeB: before fs");
  ...
  ROS_INFO("ImageNodeB: after fs");

  m_camera = camodocal::CameraFactory::instance()->generateCameraFromYamlFile(filename);
